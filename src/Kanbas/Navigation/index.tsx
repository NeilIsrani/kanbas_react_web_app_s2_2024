...
export default function KanbasNavigation() {
  ...
  return (
    <div id="wd-kanbas-navigation" className="list-group rounded-0 position-fixed bottom-0 top-0 d-none d-md-block bg-black" style={{ width: 100, zIndex: 10 }}>
      <a id="wd-neu-link" target="_blank" href="https://www.northeastern.edu/" className="list-group-item bg-black border-0">
        <img src="/images/NEU.svg" width="75px" alt="Northeastern University Logo" />
      </a>
